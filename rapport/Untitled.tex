...
La méthode de Retour Arrière Chronologique accompagnée d'une heuristique qui choisit d'instancier d'abord les mots de plus petit domaine (puis ayant le plus de contraintes binaires) donne des résultats satisfaisants même sur des grandes instances. Elle a donc été appliquée à des instances grandissantes.
...
\hline
\textbf{Taille (nombre de cases de côté)} & \textbf{Temps d'\'{e}xecution}  \\
\hline
10 & t1\\
\hline 
20 & t2\\
